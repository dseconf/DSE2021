classdef msm
  ...
  methods (Static)
    ...
    function [cri,sim_moments,sim_moments_indiv]=objective(P, data_moments, W, mp, ap, pnames, theta)
      ...
      % solve the model
      bellman0= @(V) zurcher.bellman(V, mp, P);
      [ev0,pk0,~,~]=solve.poly(bellman0, ev0, ap, mp.beta);
